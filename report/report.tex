...
\end{verbatim}
   ...
   Preimises is this. [[da...]] is proof box. Verified is
   this. The append predicate appends the assumption to the
   list of verified lines. Then, verify\_proof is recursively
   called to verify the sub-proof within the box. 
